...
namespace DB2Storage
{
    public class MySqlStorageBase<T> : Dictionary<int, T>
    {
        ...
        public void Init(string DatabaseConnectionName)
        {
            ...
            try
            {
                lConnection = new MySql.Data.MySqlClient.MySqlConnection("Server=localhost;Port=3306;UserID=root;Password=root;Database=db2;CharacterSet=utf8;ConnectionTimeout=5;");
                lConnection.Open();
            }
